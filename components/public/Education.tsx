const imgImage1 = "http://localhost:3845/assets/812e88ed61bcbd4645989a121664f637d3f3e650.png";
...
function Education() {
  return (
    ...
    >
      <div
        className="bg-center bg-cover bg-no-repeat relative shrink-0 size-[150px]"
        data-name="Image"
        id="node-51_393"
